...
//   document.getElementById("interviewCountNo").innerText = jobs.filter(j => j.status==="interview").length;
//   document.getElementById("rejectCountNo").innerText = jobs.filter(j => j.status==="rejected").length;
